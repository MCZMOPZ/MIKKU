...
module.exports = {
    ...
    GANSTYLE: process.env.GAN_IMAGE === undefined ? 'https://i.ibb.co/WtZ6BBN/Pikku-bot.png' : process.env.GAN_IMAGE,
    ...
    PLK: process.env.OWNER_NAME === undefined ? 'sͥʜͭᴀᷤᴅɪͫɴͤ' : process.env.OWNER_NAME,
    ...
    LOGOSK: process.env.ALL_IMG === undefined ? 'https://i.ibb.co/WtZ6BBN/Pikku-bot.png' : process.env.ALL_IMG,
